...
if (isset($_POST["simpan"])) {
  ...
  if ($eror === 4) {
    echo "<script>alert('Piliih gambar terlebih dahulu!')</script>";
  }

  $ekstensiGambar = ['jpg', 'png', 'jpeg'];
  $format = explode('.', $nama);
  $format =  strtolower(end($format));
  if (!in_array($format, $ekstensiGambar)) {
    ...
    $gambar = $namaBaru;
    $result = mysqli_query($conn, "INSERT INTO testimonial VALUES ('','$judul','$namaBaru','$deskripsi')");
  }
}
    ...
    <div class="main-wrapper">
      ...
      <div class="main-content">
        <section class="section">
          <form method="POST" name="forminput" enctype="multipart/form-data">
            <div class="container-fluid">
              <div class="row">
                <div class="col-12">
                  <div class="container">
                    <h1 class="mb-3 mt-4">Form Input Projek</h1>
                    <form action="simpan.php" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group row mt-5">
                        <label for="gambar" class="col-sm-4 col-form-label">img</label>
                        <div class="col-sm-8">
